...
- 1.x 19 项测试与 2.0 75 项测试全部通过，合计 94 项。
...
当前仓库版本为 **2.0.0-alpha.11**。面向用户的稳定本地功能仍以 **1.2.0** 为基线；Alpha 已把 PostgreSQL 领域模块组合成完整 API 服务，并补齐小程序 8 类云写操作的统一命令总线、原子 Outbox、乐观视图和冲突回滚；真实数据库、加密导出存储与双设备联调仍未完成。
